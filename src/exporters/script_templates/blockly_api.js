...
//
// Everything below is presentation-only: a Blockly theme, a stylesheet for the
// category sidebar, and the renderer/grid choices passed to Blockly.inject().
// None of it affects block behaviour, generated bytecode, or serialization.
//
// Reviewer's map of what's below (each is a self-contained block with its own
// "why" comment):
//   * IoConstantProvider / IoRenderer  - custom 'io_zelos' renderer: rounded
//       fields; a softened rounded-hexagon connection shape for the schedule's
//       cron_* sockets (see makeSoftHexagonal + shapeFor).
//   * palette vibrancy (setHsvSaturation/Value) + snapRadius.
//   * Field prototype extensions: checkbox look, mutator cog, template-field
//       sizing, floating-value click-to-select, mutator close-on-outside-click.
//   * ioModernTheme - fonts, workspace surface, selection/cursor colours.
//   * Blockly.Css.register(...) - sidebar chrome, category icons, checkbox,
//       field edit-widget ring, dropdown checkmark, white block borders.
//   * buildInjectOptions - renderer/theme/grid handed to Blockly.inject().
//
...
// a clean orange). Applies to every hue-based block colour.
...
Blockly.Css.register(`
  ...
  .io-cat-icon-triggers     { background-image: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 640' fill='%23E85C40'><path d='M128 320L156.5 92C158.5 76 172.1 64 188.3 64L356.9 64C371.9 64 384 76.1 384 91.1C384 94.3 383.4 97.6 382.3 100.6L336 224L475.3 224C495.5 224 512 240.4 512 260.7C512 268.1 509.8 275.3 505.6 281.4L313.4 562.4C307.5 571 297.8 576.1 287.5 576.1L284.6 576.1C268.9 576.1 256.1 563.3 256.1 547.6C256.1 545.3 256.4 543 257 540.7L304 352L160 352C142.3 352 128 337.7 128 320z'/></svg>"); }
